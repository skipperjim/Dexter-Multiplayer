    ...
    .defines(function()
    {
        EntityPlayer = ig.Entity.extend({
            ...
            update: function(){
                ...
                socket.emit('moveplayer', this.pos.x, this.pos.y, this.gamename);
                // move left or right
        ...
        EntityOtherPlayer = ig.Entity.extend({
            ...
            update: function(){
                ...
                // shoot
                if(ig.input.pressed('shoot')){
                    socket.emit('spawnbullet', this.bulletType, this.gamename);
                    ig.game.spawnEntity(this.weapon, this.pos.x, this.pos.y, {flip:this.flip});
                    this.shootSFX.volume = 0.2;
                    this.shootSFX.play();
                }
                // set the current animation, based on player's speed
